...
# 1. Replace the wrapper in Home.vue
wrapper_old = """        <div class="home-video-wrapper" v-if="company?.company_video_embed && company?.home_show_video">
          <iframe 
...
if "const pageTexts = ref({})" in content:
...
print("Home.vue updated successfully!")
