...
const builtInTranslations = {
  zh: {
    ...
    shipListTitle: '船舶列表',
    shipRealtime: '实时动态',
    shipParticulars: '船舶资料',
    shipHeading: '船艏向',
    shipDataSource: '数据源',
    shipMapHint: '点击船舶标记查看详情',
    shipMapFailed: '地图加载失败，请检查网络连接',
    shipNoPosition: '暂无位置',
    shipLocate: '地图定位',
    shipClose: '关闭',
    shipLegendBulk: '散货船',
  ...
  en: {
    ...
    shipRefresh: 'Refresh',
    shipListTitle: 'Vessel List',
    shipRealtime: 'Live Status',
    shipParticulars: 'Ship Particulars',
    shipHeading: 'Heading',
    shipDataSource: 'Data Source',
    shipMapHint: 'Click a vessel marker for details',
    shipMapFailed: 'Map failed to load, please check your connection',
    shipNoPosition: 'No position',
    shipLocate: 'Locate on map',
    shipClose: 'Close',
    shipLegendBulk: 'Bulk Carrier',
    shipLegendCargo: 'Cargo',
    shipLegendTanker: 'Tanker',
    shipLegendPassenger: 'Passenger',
    shipLegendOther: 'Other',
